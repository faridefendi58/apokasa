    ...
    foreach (Yii::app()->user->getState('items_belanja') as $index => $data) {
        ...
        <tr class="<?php echo ($no % 2 > 0) ? 'even' : 'odd'; ?>">
            ...
            <td style="text-align:right;"
                id="unit-price-<?php echo $index; ?>"><?php echo number_format($data['unit_price'], 0, ',', '.'); ?></td>
            <td style="text-align:center;">
                <?php echo CHtml::textField(
                        ...
                        array(
                            ...
                            'onclick' => 'this.select()',
                            'onchange' => 'pushQty(' . $index . ',this,"' . Yii::app()->createUrl('/' . Yii::app()->controller->module->id . '/orders/updateQty') . '")'
                        )
                ); ?>
            </td>
